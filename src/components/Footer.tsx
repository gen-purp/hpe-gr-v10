        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-2xl font-bold">Horsepower Electric</span>
            </div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" className="text-gray-400 hover:text-yellow-500 transition-colors">
                ...
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.62 5.367 11.987 11.988 11.987 6.62 0 11.987-5.367 11.987-11.987C24.014 5.367 18.637.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.49-3.323-1.297C4.198 14.895 3.708 13.744 3.708 12.447s.49-2.448 1.297-3.323c.875-.807 2.026-1.297 3.323-1.297s2.448.49 3.323 1.297c.807.875 1.297 2.026 1.297 3.323s-.49 2.448-1.297 3.323c-.875.807-2.026 1.297-3.323 1.297zm7.83-9.781H7.83c-.49 0-.89.4-.89.89v8.898c0 .49.4.89.89.89h8.449c.49 0 .89-.4.89-.89V8.097c0-.49-.4-.89-.89-.89z"/>
                </svg>
              </a>
              <a href="#" className="text-gray-400 hover:text-yellow-500 transition-colors">
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-300">
              <p>📞 (555) 123-4567</p>
              <p>✉️ info@horsepowerelectric.com</p>
              <p>📍 123 Electric Ave<br />Your City, ST 12345</p>
              <p>🕒 Mon-Fri: 7AM-6PM<br />Sat: 8AM-4PM</p>
            </div>
          </div>
        </div>

        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; 2024 Horsepower Electric. All rights reserved. | Licensed & Insured</p>
        </div>
      </div>
    </footer>
  );
